			...
			<div class="colorlib-about">
				<div class="colorlib-narrow-content">
					<div class="row row-bottom-padded-md">
						<div class="col-md-6">
							<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(images/ct.jpg);">
							</div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
								...
								Cognizant is a multinational company that provides IT services,including digital,technology,consulting and operations services.<br>The headquarters of Cognizant is located in
								Teaneck,New Jersey,United States<br>

			...
			<div class="colorlib-about">
				<div class="colorlib-narrow-content">
					<div class="row row-bottom-padded-md">
						<div class="col-md-6">
							<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(images/e11.jpg);">
							</div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
								...
								With a focus on electrification, automation and digitalization, Siemens India stands for engineering excellence, innovation, and reliability.<br> As one of the world’s biggest producers of energy-efficient, resource-saving technologies, Siemens is a pioneer in infrastructure and energy solutions, as well as automation and software for industry.<br>The company is also a leader in medical imaging equipment, laboratory diagnostics, and clinical IT.<br> Siemens also provides business-to-business financial solutions, rail automation and wind power solutions.
      </div></font>
						</div>
					</div>

			...
			<div class="colorlib-about">
				<div class="colorlib-narrow-content">
					<div class="row row-bottom-padded-md">
						<div class="col-md-6">
							<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(images/ramco.png);">
							</div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
								...
								<h2 class="colorlib-heading">Who we are</h2><font size=3>
									Ramco Cements. Ramco Cements Limited (formerly Madras Cements Ltd) is the flagship company of the Ramco Group, a business group based in Chennai, South India. It is the fifth largest cement producer in India.It manufactures and markets Portland cement, blast furnace slag cement, white cement and Pozzolana cement.
								</div></font>
						</div>
					</div>

			...
			<div class="colorlib-about">
				<div class="colorlib-narrow-content">
					<div class="row row-bottom-padded-md">
						<div class="col-md-6">
							<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(images/e12.jpg);">
							</div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
								...
								Daimler India Commercial Vehicles Pvt.<br> Ltd. is a subsidiary of the German Daimler AG.<br> This company designs, manufactures, and sells commercial vehicles that cater to the demands of Indian customers and are designed with nation's terrain in mind.<br> These vehicles are branded as "BharatBenz", "Mercedes Benz" and "Fuso".
      </div></font>
						</div>
					</div>
